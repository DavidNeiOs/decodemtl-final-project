...
class OrgProfile extends Component {
  ...
  handleChange(evt, { name, value }) {
    // if the property to change is the logo then upload the file
    if (name === "logo") {
  ...
  handleSubmit() {
    ...
    // if everything is ok make a copy of object and send it to backend
              ...
              <Grid.Column width={3}>
                <Segment color="blue">
                  <Image
                    wrapped
                    size="medium"
                    src={"/images/" + this.props.org[0].logo}
                  />
                </Segment>
              </Grid.Column>
