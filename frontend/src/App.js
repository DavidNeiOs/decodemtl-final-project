...
const reducer = function(state, action) {
  // *** Reducer used in this project to control what view the user is interacting with ***
  switch (action.type) {
    case "homepage":
      return {
        ...state,
        showHomepage: action.content,
        showOrgPage: false,
        showBuyerPage: false,
    ...
    case "showCreateL":
      return {
        ...state,
        showCreateListing: action.content,
        showOrgPage: false,
        showUpdateItemPage: false
      };
    ...
    case "showBuyerPage":
      return {
        ...state,
        showLogIn: false,
        currentBuyer: action.content,
        showBuyerPage: true,
        buyerId: action.content.userId,
        showHomepage: false
      };
    ...
    case "showBuyerProfile":
      return {
        ...state,
        showBuyerPage: false,
        showBuyerProfile: action.content
      };
